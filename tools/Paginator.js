...
class Paginator {
  constructor(message, promises, isPromise=false, promiseResSize=null, paginateStep, length, preProcess=null, {lengthEnabled = true, goldenCardMode = false}){
    /*
  ...
  async showMessages(targetCards){
    ...
    if( this.prevMessage ) this.prevMessage.delete().catch(console.log);
